!function () {
  ...
  function e(e) {
        ...
        case "number":
          !function (e) {
            if (isFinite(e) && Math.floor(e) === e) {
              if (e >= 0 && e <= 127) u(e);else if (e < 0 && e >= -32) u(e);else if (e > 0 && e <= 255) c([204, e]);else if (e >= -128 && e <= 127) c([208, e]);else if (e > 0 && e <= 65535) c([205, e >>> 8, e]);else if (e >= -32768 && e <= 32767) c([209, e >>> 8, e]);else if (e > 0 && e <= 4294967295) c([206, e >>> 24, e >>> 16, e >>> 8, e]);else if (e >= -2147483648 && e <= 2147483647) c([210, e >>> 24, e >>> 16, e >>> 8, e]);else if (e > 0 && e <= 0x10000000000000000) {
                let r = e / t,
                    n = e % t;
                c([211, r >>> 24, r >>> 16, r >>> 8, r, n >>> 24, n >>> 16, n >>> 8, n]);
              } else e >= -0x8000000000000000 && e <= 0x8000000000000000 ? (u(211), s(e)) : c(e < 0 ? [211, 128, 0, 0, 0, 0, 0, 0, 0] : [207, 255, 255, 255, 255, 255, 255, 255, 255]);
            } else n || (r = new ArrayBuffer(8), n = new DataView(r)), n.setFloat64(0, e), u(203), c(new Uint8Array(r));
          }(e);
          break;
          ...
          !function (e) {
            let t = function (e) {
              ...
              for (let t = 0; t !== r; t++) {
                ...
                if (o < 128) i[n++] = o;else {
                  if (o < 2048) i[n++] = o >> 6 | 192;else {
                    if (o > 55295 && o < 56320) {
                      if (++t >= r) throw new Error("UTF-8 encode: incomplete surrogate pair");
                      let f = e.charCodeAt(t);
                      if (f < 56320 || f > 57343) throw new Error("UTF-8 encode: second surrogate character 0x" + f.toString(16) + " at index " + t + " out of range");
                      o = 65536 + ((1023 & o) << 10) + (1023 & f), i[n++] = o >> 18 | 240, i[n++] = o >> 12 & 63 | 128;
                    } else i[n++] = o >> 12 | 224;
            ...
            r <= 31 ? u(160 + r) : c(r <= 255 ? [217, r] : r <= 65535 ? [218, r >>> 8, r] : [219, r >>> 24, r >>> 16, r >>> 8, r]);
            c(t);
          }(e);
          break;

        case "object":
          null === e ? a(e) : e instanceof Date ? function (e) {
            let r = e.getTime() / 1e3;
            if (0 === e.getMilliseconds() && r >= 0 && r < 4294967296) c([214, 255, r >>> 24, r >>> 16, r >>> 8, r]);else if (r >= 0 && r < 17179869184) {
              ...
              c([199, 12, 255, t >>> 24, t >>> 16, t >>> 8, t]), s(r);
            }
          }(e) : Array.isArray(e) ? l(e) : e instanceof Uint8Array || e instanceof Uint8ClampedArray ? function (e) {
            let t = e.length;
            c(t <= 15 ? [196, t] : t <= 65535 ? [197, t >>> 8, t] : [198, t >>> 24, t >>> 16, t >>> 8, t]);
            c(e);
          }(e) : e instanceof Int8Array || e instanceof Int16Array || e instanceof Uint16Array || e instanceof Int32Array || e instanceof Uint32Array || e instanceof Float32Array || e instanceof Float64Array ? l(e) : function (e) {
            let t = 0;

            for (let r in e) t++;

            t <= 15 ? u(128 + t) : c(t <= 65535 ? [222, t >>> 8, t] : [223, t >>> 24, t >>> 16, t >>> 8, t]);

            for (let t in e) f(t), f(e[t]);
          }(e);
      }
    }
    ...
    function l(e) {
      let t = e.length;
      t <= 15 ? u(144 + t) : c(t <= 65535 ? [220, t >>> 8, t] : [221, t >>> 24, t >>> 16, t >>> 8, t]);

      for (let r = 0; r < t; r++) f(e[r]);
    }
    ...
    function c(e) {
      if (i.length < o + e.length) {
        let t = 2 * i.length;

        for (; t < o + e.length;) t *= 2;
    ...
    function s(e) {
      let r, n;
      e >= 0 ? (r = e / t, n = e % t) : (e++, r = ~(r = Math.abs(e) / t), n = ~(n = Math.abs(e) % t)), c([r >>> 24, r >>> 16, r >>> 8, r, n >>> 24, n >>> 16, n >>> 8, n]);
    }
  }
  ...
  function t(e) {
    ...
    function i() {
      ...
      if (t >= 128 && t <= 143) return u(t - 128);
      if (t >= 144 && t <= 159) return c(t - 144);
      if (t >= 160 && t <= 191) return s(t - 160);
      if (192 === t) return null;
      if (193 === t) throw new Error("Invalid byte code 0xc1 found.");
      if (194 === t) return !1;
      if (195 === t) return !0;
      if (196 === t) return l(-1, 1);
      if (197 === t) return l(-1, 2);
      if (198 === t) return l(-1, 4);
      if (199 === t) return d(-1, 1);
      if (200 === t) return d(-1, 2);
      if (201 === t) return d(-1, 4);
      if (202 === t) return a(4);
      if (203 === t) return a(8);
      if (204 === t) return f(1);
      if (205 === t) return f(2);
      ...
      if (214 === t) return d(4);
      if (215 === t) return d(8);
      if (216 === t) return d(16);
      if (217 === t) return s(-1, 1);
      if (218 === t) return s(-1, 2);
      if (219 === t) return s(-1, 4);
      if (220 === t) return c(-1, 2);
      if (221 === t) return c(-1, 4);
      if (222 === t) return u(-1, 2);
      if (223 === t) return u(-1, 4);
    ...
    function s(t, n) {
      ...
      return r += t, function (e, t, r) {
        ...
        for (; n < r;) {
          ...
          if (t <= 65535) i += String.fromCharCode(t);else {
      ...
      switch (i) {
        case 255:
          return function (e) {
            ...
            if (8 === e.length) {
              let r = (e[0] << 22 >>> 0) + (e[1] << 14 >>> 0) + (e[2] << 6 >>> 0) + (e[3] >>> 2),
                  n = (3 & e[3]) * t + (e[4] << 24 >>> 0) + (e[5] << 16 >>> 0) + (e[6] << 8 >>> 0) + e[7];
  ...
  "object" == typeof module && module && "object" == typeof module.exports ? module.exports = r : window[window.msgpackJsName || "msgpack"] = r;
